...
?>
		...
		<div class="span7 homeabout">
				<div class="person">
					...
					<div class="font16"> <p style="color:#000000;">Ваши сообщения</p>
                    <section>
						<section>
							<div>
                            <div>
                              ...
                              if(isset($_POST["vzyat"])){
                                ...
                                $query4 = "INSERT INTO trgames.mess(`text`, `idIgroka`, `idRukovodit`) 
                                                ...
                                                if ($conn->query($query4) === TRUE) {
                                                    exit('<meta http-equiv="refresh" content="0; url=messageus.php" />');
							  ...
							  $query23 = "SELECT `idmess`,`text`, `idIgroka`, `idRukovodit` FROM `mess` WHERE `idRukovodit`='$usname' ";
									...
									?>
										<tr>
											...
											</td><form action="messageus.php" method="POST">
											<td class="col2">
												<?php echo $row15["text"]; ?>
                                ...
                                <?php
								include "connect.php";
								echo'<form  class="col3" action="messageus.php" method="POST">';
							$query2 = "select idRukovodit,Фамилия,Имя,login from игропрактик;";
							$result = $conn->query($query2);
                            echo "<p style=color:#000000;> Написать сообщение игропрактику";
							echo "<label> <p style=color:#000000;>Выберите игропрактика:";
