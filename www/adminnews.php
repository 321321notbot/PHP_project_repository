      ...
      <div id="page-wrapper">
         ...
         <article id="main">
            <header>
               ...
               <p>Здесь размещаются новости наших игропрактиков</p>
            </header>
            <section class="wrapper style5">
               <div class="inner">
                  <?php     
                     ...
                     ?>
                  <h3><?php echo $row156["заголовок"];?></h3>
                  <p><span class="image left"><img src="<?php echo "images/",$row156["img"];?>"  /></span><?php echo $row156["текст"];?></p>
                  <hr />
                  <?php endwhile; ?>
                  <?php	
                     $usname=$_SESSION["username"];
