      ...
      <div class="container topbottom">
         <div class="row-fluid">
            ...
            <?php
               ...
               $query3 = "update trgames.игрок set `Фамилия`='$Fam1', `Имя`='$Name1', `Отчество`='$otch1',`О себе`='$emai1' where `login` = '$usname'";
               echo $query3;
               ...
               $result2 = "SELECT `Фамилия`, `Имя`, `Отчество`,`О себе` FROM игрок WHERE `login` = '$usname'";  
            ...
            <div class="span7 homeabout">
               <div class="person">
                  ...
                  <div class="font16">
                     <p style="color:#000000;">Изменение персоналньых данных</p>
                  </div>
                  <section>
                  <section>
                     <div>
                        <div>
                           <div class="container">
                              <div>
                                 <div>
                                    <form action="changePers.php" method="POST" name="form1">
                                       <fieldset>
