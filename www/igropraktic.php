            ...
            <div class="inner">
               ...
               <p><span style= width:180px; style= height:180px; class="image left"><img src="<?php echo "images/",$row1["img"];?>" alt="" /></span> <?php echo $row1["О себе"]; ?>
                  <?php 
                     ...
                     echo "<br><strong>Номер телефона: </strong>", $row1["Телефон"],"<br>";?>
               </p>
               <br>
               <h2>Фотоальбом игропрактика</h2>
               <div class="box alt">
                  ...
                  <div class="inner">
                     ...
                     <?php                               
                        ...
                        while ($row156 = mysqli_fetch_array($result1091)):
                        	?>
                     <p>
                     <h4><?php echo $row156["Заголовок"];?></h4>
                     <span class="image left"><img src="<?php echo "images/",$row156["img"];?>"  /></span><?php echo $row156["text"];?></p>
                     <?php endwhile; ?>
               ...
               <label for="demo-copy">Отправить копью на почту</label>
               </div>
               <div class="col-6 col-12-small">
